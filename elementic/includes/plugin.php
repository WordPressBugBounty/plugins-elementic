...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Elementic\Plugin The single instance of the class.
	 */
	...
	public function init() {
		add_action( 'elementor_pro/forms/actions/register', [ $this, 'register_forms_controls' ] );
	}
	 ...
	 */
	public function register_forms_controls( $controls_manager ) {

		require_once( __DIR__ . '/controls/Elementic_Form_Action.php' );

		$controls_manager->register( new \Elementic_Form_Action() );
